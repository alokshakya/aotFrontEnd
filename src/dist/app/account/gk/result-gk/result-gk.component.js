...
var ResultGkComponent = (function () {
    function ResultGkComponent(misc) {
        this.misc = misc;
        this.detailedResult = {
            "Chapterwise Test": {
                "Chapter 1": {
    ...
    ResultGkComponent.prototype.show = function (i, j) {
        this.chapter = {};
    ...
    ResultGkComponent.prototype.sampleResult = function (s) {
        this.sample = {};
        this.sample = this.detailedResult['Sample Test'][s];
        this.currentSample = s;
        this.showSample = true;
    };
    ResultGkComponent.prototype.demoResult = function (number) {
        this.demo = { number: number };
        this.demo = this.detailedResult['Demo Test'][number];
        this.currentDemo = number;
        this.showDemo = true;
    };
    ResultGkComponent.prototype.mockResult = function (number) {
        this.mock = {};
        this.mock = this.detailedResult['Mock Test'][number];
        this.currentMock = number;
        this.showMock = true;
    };
    ResultGkComponent.prototype.close = function (e) {
        this.showChapter = false;
        this.showDemo = false;
        this.showSample = false;
        this.showMock = false;
    };
    ResultGkComponent.prototype.showPanel = function (e) {
    };
    ResultGkComponent.prototype.ngOnInit = function () {
    ...
    return ResultGkComponent;
}());
ResultGkComponent = __decorate([
    Component({
...
export { ResultGkComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/gk/result-gk/result-gk.component.js.map