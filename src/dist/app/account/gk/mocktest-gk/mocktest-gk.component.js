...
var MocktestGkComponent = (function () {
    function MocktestGkComponent(router, subjectInfo, misc) {
        this.router = router;
    ...
    MocktestGkComponent.prototype.redirect = function () {
        this.router.navigate(['account/accountsettings']);
    };
    MocktestGkComponent.prototype.ngOnInit = function () {
        this.misc.setCurrentRoute(["General-Knowledge", "Mock Test"]);
        this.misc.setLocalRoute('account/gk/mocktest');
        //for chart
        this.mockTestData = {
    ...
    return MocktestGkComponent;
}());
MocktestGkComponent = __decorate([
    Component({
...
export { MocktestGkComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/gk/mocktest-gk/mocktest-gk.component.js.map