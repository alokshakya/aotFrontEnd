...
var SampletestMathComponent = (function () {
    function SampletestMathComponent(router, misc, subjectInfo) {
        this.router = router;
        this.misc = misc;
    ...
    SampletestMathComponent.prototype.ngOnInit = function () {
    ...
    SampletestMathComponent.prototype.redirect = function () {
        this.router.navigate(['account/accountsettings']);
    };
    return SampletestMathComponent;
}());
SampletestMathComponent = __decorate([
    Component({
...
export { SampletestMathComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/mathematics/sampletest-math/sampletest-math.component.js.map