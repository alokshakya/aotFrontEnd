...
var MocktestMathComponent = (function () {
    function MocktestMathComponent(router, subjectInfo, misc) {
        this.router = router;
    ...
    MocktestMathComponent.prototype.redirect = function () {
        this.router.navigate(['account/accountsettings']);
    };
    MocktestMathComponent.prototype.ngOnInit = function () {
    ...
    return MocktestMathComponent;
}());
MocktestMathComponent = __decorate([
    Component({
...
export { MocktestMathComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/mathematics/mocktest-math/mocktest-math.component.js.map