...
var ResultMathComponent = (function () {
    function ResultMathComponent(misc) {
        this.misc = misc;
        this.detailedResult = {
            "Chapterwise Test": {
                "Chapter 1": {
    ...
    ResultMathComponent.prototype.show = function (i, j) {
        this.chapter = {};
    ...
    ResultMathComponent.prototype.sampleResult = function (s) {
        this.sample = {};
        this.sample = this.detailedResult['Sample Test'][s];
        this.currentSample = s;
        this.showSample = true;
    };
    ResultMathComponent.prototype.demoResult = function (number) {
        this.demo = { number: number };
        this.demo = this.detailedResult['Demo Test'][number];
        this.currentDemo = number;
        this.showDemo = true;
    };
    ResultMathComponent.prototype.mockResult = function (number) {
        this.mock = {};
        this.mock = this.detailedResult['Mock Test'][number];
        this.currentMock = number;
        this.showMock = true;
    };
    ResultMathComponent.prototype.close = function (e) {
        this.showChapter = false;
        this.showDemo = false;
        this.showSample = false;
        this.showMock = false;
    };
    ResultMathComponent.prototype.showPanel = function (e) {
    };
    ResultMathComponent.prototype.ngOnInit = function () {
    ...
    return ResultMathComponent;
}());
ResultMathComponent = __decorate([
    Component({
...
export { ResultMathComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/mathematics/result-math/result-math.component.js.map