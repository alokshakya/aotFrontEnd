...
var SampletestEnglishComponent = (function () {
    function SampletestEnglishComponent(router, misc, subjectInfo) {
        this.router = router;
        this.misc = misc;
    ...
    SampletestEnglishComponent.prototype.ngOnInit = function () {
    ...
    SampletestEnglishComponent.prototype.redirect = function () {
        this.router.navigate(['account/accountsettings']);
    };
    return SampletestEnglishComponent;
}());
SampletestEnglishComponent = __decorate([
    Component({
...
export { SampletestEnglishComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/english/sampletest-english/sampletest-english.component.js.map