...
var MocktestEnglishComponent = (function () {
    function MocktestEnglishComponent(router, subjectInfo, misc) {
        this.router = router;
    ...
    MocktestEnglishComponent.prototype.redirect = function () {
        this.router.navigate(['account/accountsettings']);
    };
    MocktestEnglishComponent.prototype.ngOnInit = function () {
    ...
    return MocktestEnglishComponent;
}());
MocktestEnglishComponent = __decorate([
    Component({
...
export { MocktestEnglishComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/english/mocktest-english/mocktest-english.component.js.map