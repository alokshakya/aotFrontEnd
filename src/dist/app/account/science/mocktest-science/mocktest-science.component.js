...
var MocktestScienceComponent = (function () {
    function MocktestScienceComponent(router, subjectInfo, misc) {
        this.router = router;
    ...
    MocktestScienceComponent.prototype.redirect = function () {
        this.router.navigate(['account/accountsettings']);
    };
    MocktestScienceComponent.prototype.ngOnInit = function () {
    ...
    return MocktestScienceComponent;
}());
MocktestScienceComponent = __decorate([
    Component({
...
export { MocktestScienceComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/science/mocktest-science/mocktest-science.component.js.map