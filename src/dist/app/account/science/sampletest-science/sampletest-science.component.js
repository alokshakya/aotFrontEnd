...
var SampletestScienceComponent = (function () {
    function SampletestScienceComponent(router, misc, subjectInfo) {
        this.router = router;
        this.misc = misc;
    ...
    SampletestScienceComponent.prototype.ngOnInit = function () {
    ...
    SampletestScienceComponent.prototype.redirect = function () {
        this.router.navigate(['account/accountsettings']);
    };
    return SampletestScienceComponent;
}());
SampletestScienceComponent = __decorate([
    Component({
...
export { SampletestScienceComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/science/sampletest-science/sampletest-science.component.js.map