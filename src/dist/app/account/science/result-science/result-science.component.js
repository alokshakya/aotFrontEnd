...
var ResultScienceComponent = (function () {
    function ResultScienceComponent(misc) {
        this.misc = misc;
        this.detailedResult = {
            "Chapterwise Test": {
                "Chapter 1": {
    ...
    ResultScienceComponent.prototype.show = function (i, j) {
        this.chapter = {};
    ...
    ResultScienceComponent.prototype.sampleResult = function (s) {
        this.sample = {};
        this.sample = this.detailedResult['Sample Test'][s];
        this.currentSample = s;
        this.showSample = true;
    };
    ResultScienceComponent.prototype.demoResult = function (number) {
        this.demo = { number: number };
        this.demo = this.detailedResult['Demo Test'][number];
        this.currentDemo = number;
        this.showDemo = true;
    };
    ResultScienceComponent.prototype.mockResult = function (number) {
        this.mock = {};
        this.mock = this.detailedResult['Mock Test'][number];
        this.currentMock = number;
        this.showMock = true;
    };
    ResultScienceComponent.prototype.close = function (e) {
        this.showChapter = false;
        this.showDemo = false;
        this.showSample = false;
        this.showMock = false;
    };
    ResultScienceComponent.prototype.showPanel = function (e) {
    };
    ResultScienceComponent.prototype.ngOnInit = function () {
    ...
    return ResultScienceComponent;
}());
ResultScienceComponent = __decorate([
    Component({
...
export { ResultScienceComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/science/result-science/result-science.component.js.map