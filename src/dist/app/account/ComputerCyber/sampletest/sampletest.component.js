...
var SampletestComponent = (function () {
    function SampletestComponent(router, misc, subjectInfo) {
        this.router = router;
        this.misc = misc;
    ...
    SampletestComponent.prototype.ngOnInit = function () {
    ...
    SampletestComponent.prototype.redirect = function () {
        this.router.navigate(['account/accountsettings']);
    };
    return SampletestComponent;
}());
SampletestComponent = __decorate([
    Component({
...
export { SampletestComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/ComputerCyber/sampletest/sampletest.component.js.map