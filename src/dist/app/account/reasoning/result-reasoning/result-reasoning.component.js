...
var ResultReasoningComponent = (function () {
    function ResultReasoningComponent(misc) {
        this.misc = misc;
        this.detailedResult = {
            "Chapterwise Test": {
                "Chapter 1": {
    ...
    ResultReasoningComponent.prototype.show = function (i, j) {
        this.chapter = {};
    ...
    ResultReasoningComponent.prototype.sampleResult = function (s) {
        this.sample = {};
        this.sample = this.detailedResult['Sample Test'][s];
        this.currentSample = s;
        this.showSample = true;
    };
    ResultReasoningComponent.prototype.demoResult = function (number) {
        this.demo = { number: number };
        this.demo = this.detailedResult['Demo Test'][number];
        this.currentDemo = number;
        this.showDemo = true;
    };
    ResultReasoningComponent.prototype.mockResult = function (number) {
        this.mock = {};
        this.mock = this.detailedResult['Mock Test'][number];
        this.currentMock = number;
        this.showMock = true;
    };
    ResultReasoningComponent.prototype.close = function (e) {
        this.showChapter = false;
        this.showDemo = false;
        this.showSample = false;
        this.showMock = false;
    };
    ResultReasoningComponent.prototype.showPanel = function (e) {
    };
    ResultReasoningComponent.prototype.ngOnInit = function () {
    ...
    return ResultReasoningComponent;
}());
ResultReasoningComponent = __decorate([
    Component({
...
export { ResultReasoningComponent };
//# sourceMappingURL=C:/Users/Gaurav/Desktop/ob-development/fronty/src/app/account/reasoning/result-reasoning/result-reasoning.component.js.map