...
export class ChapterwisetestGkComponent implements OnInit {
    ...
    makeGraph(){
        this.chapterwiseTestData = {
            ...
            datasets: [{
                data: [
                        this.chapterwiseTest.gk['total_tests']-this.chapterwiseTest.gk['total_generated'], 
                        this.chapterwiseTest.gk['total_completed'], 
                        this.chapterwiseTest.gk['total_generated']
                        ],
