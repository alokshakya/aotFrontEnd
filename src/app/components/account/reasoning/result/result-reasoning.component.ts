...
detailedResult: any;
    ...
    //     let obj = this.Result.reasoning['chapters'][i];
    //     let correct = 0;
    //     let marked = 0;
    //     let incorrect = 0;
    ...
    //     let correct = this.Result.reasoning.chapters[chapter]['tests'][test]['result']['correct'];
    //     let incorrect = this.Result.reasoning.chapters[chapter]['tests'][test]['result']['incorrect'];
    //     let marked = this.Result.reasoning.chapters[chapter]['tests'][test]['result']['marked'];
    //     let total = this.Result.reasoning.chapters[chapter]['tests'][test]['total_no_question'];
    //     if(toggle){
