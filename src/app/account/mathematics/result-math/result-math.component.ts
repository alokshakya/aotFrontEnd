...
detailedResult: any;
    ...
    clubbedWidth(i,toggle=false){
        let obj = this.Result.math['chapters'][i];
        let correct = 0;
        let marked = 0;
        let incorrect = 0;
    ...
    width(chapter,test,toggle=false){
        let correct = this.Result.math.chapters[chapter]['tests'][test]['result']['correct'];
        let incorrect = this.Result.math.chapters[chapter]['tests'][test]['result']['incorrect'];
        let marked = this.Result.math.chapters[chapter]['tests'][test]['result']['marked'];
        let total = this.Result.math.chapters[chapter]['tests'][test]['total_no_question'];
        if(toggle){
